...
function evr_post_update_event(){
    global $wpdb;
        ...
        //note about coupon code - coupon code information is not posted here, but from the item cost page.
        	...
        	<div id="message" class="updated fade"><p><strong><?php _e('The Event details saved for ','evr_language'); echo stripslashes($_REQUEST['event']); _e(' has been updated!','evr_language');?></a></p>
