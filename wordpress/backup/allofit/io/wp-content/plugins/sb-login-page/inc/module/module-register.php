                ...
                <div class="sb-signup-container">
                    <form class="sb-signup-form" action="" name="sb-signup-form" method="post">
                        <div class="form-group">
                            <h2 class="form-title"><?php _e('Đăng ký tài khoản', 'sb-login-page'); ?></h2>
                        </div>
                        <div class="form-group">
                            <?php
                        ...
                        <div class="form-group">
                            <?php
                            $text = __('Số điện thoại', 'sb-login-page');
                            $class = 'form-control';
                            $key = 'phone';
                        ...
                        <div class="form-group">
                            <?php
                            $text = __('Mật khẩu', 'sb-login-page');
                            $class = 'form-control';
                            $key = 'password';
                        ...
                        <div class="form-group">
                            <?php
                            $text = __('Xác nhận mật khẩu', 'sb-login-page');
                            $class = 'form-control';
                            $key = 'password-2';
                        ...
                        <button type="submit" class="btn btn-primary signup-submit btn-submit"><?php _e('Tạo tài khoản', 'sb-login-page'); ?></button>
