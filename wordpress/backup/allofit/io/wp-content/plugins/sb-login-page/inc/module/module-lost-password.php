    ...
    <div class="sb-login-section-container">
        ...
        <form class="<?php echo $form_class; ?>">
            <div class="form-group">
                <h2 class="form-title"><?php _e('Quên mật khẩu', 'sb-login-page'); ?></h2>
            </div>
            <div class="form-group">
                <?php if('verify' == $step) : ?>
                ...
                <?php elseif('reset' == $step) : ?>
                    <?php $text = __('Nhập mật khẩu mới', 'sb-login-page'); ?>
                    ...
                    <?php $text = __('Nhập lại mật khẩu', 'sb-login-page'); ?>
            ...
            <div class="form-group">
                <div class="errors">
                    <?php
                        if(!empty($step)) {
                            _e('Mã xác nhận của bạn nhập không đúng.', 'sb-login-page');
                        } else {
                            _e('Tài khoản hoặc địa chỉ email không tồn tại.', 'sb-login-page');
                        }
                    ?>
                </div>
            </div>
        ...
        <div class="login-links">
            <a href="<?php echo SB_User::get_login_url(); ?>"><?php _e('Đăng nhập', 'sb-login-page'); ?></a>
