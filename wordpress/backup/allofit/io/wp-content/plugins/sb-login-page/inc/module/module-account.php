    ...
    <div class="sb-user-profile-container">
        <div class="dashboard">
            ...
            <div class="module profile-tools">
                <ul class="profile-list">
                    <li><a href="<?php echo $account_page_url; ?>"><?php _e('Thông tin tài khoản', 'sb-login-page'); ?></a></li>
                    <li><a href="<?php echo add_query_arg(array('setting' => 'password'), $account_page_url); ?>"><?php _e('Mật khẩu', 'sb-login-page'); ?></a></li>
                    <li><a href="<?php echo add_query_arg(array('setting' => 'contact'), $account_page_url); ?>"><?php _e('Thông tin cá nhân', 'sb-login-page'); ?></a></li>
                    <li><a href="<?php echo $logout_url; ?>"><?php _e('Thoát', 'sb-login-page'); ?></a></li>
                </ul>
            </div>
        </div>
        <div class="content-main">
            <?php if('contact' == $setting_page) : ?>
                <div class="module">
                    <div class="header">
                        <h2><?php _e('Thông tin cá nhân', 'sb-login-page'); ?></h2>
                        <p class="description"><?php _e('Thay đổi thông tin cá nhân và thông tin liên hệ cho tài khoản của bạn', 'sb-login-page'); ?></p>
                    </div>
                    <div class="content-inner">
                        <div class="control-group name">
                            <label for="user-name"><?php _e('Họ và tên', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                <input type="text" id="user-name" class="user-name" name="user-name" value="<?php echo $user->display_name; ?>" autocomplete="off">
                                <p class="description"><?php _e('Họ và tên thật của bạn.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group gender">
                            <label for="user-gender"><?php _e('Giới tính', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                <select class="user-gender" name="user-gender" autocomplete="off">
                                    <option value="0" <?php selected(0, $gender); ?>><?php _e('Nam', 'sb-login-page'); ?></option>
                                    <option value="1" <?php selected(1, $gender); ?>><?php _e('Nữ', 'sb-login-page'); ?></option>
                                </select>
                                <p class="description"><?php _e('Chọn thông tin giới tính của bạn.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group birthday">
                            <label for="user-birthday"><?php _e('Ngày sinh', 'sb-login-page'); ?></label>
                            <div class="controls birthday">
                                ...
                                <p class="description">
                                    <?php
                                    if('vi' == $lang) {
                                        _e('Chọn thông tin ngày sinh của bạn theo định dạng d/m/Y.', 'sb-login-page');
                                    } else {
                                        _e('Chọn thông tin ngày sinh của bạn theo định dạng Y/m/d.', 'sb-login-page');
                                    }
                                    ?>
                                </p>
                            </div>
                        ...
                        <div class="control-group phone">
                            <label for="user-phone"><?php _e('Số điện thoại', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                ...
                                <p class="description"><?php _e('Số điện thoại của bạn đang sử dụng.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group identity">
                            <label for="user-identity"><?php _e('CMND', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                ...
                                <p class="description"><?php _e('Số chứng minh nhân dân của bạn.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group address">
                            <label for="user-address"><?php _e('Địa chỉ', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                ...
                                <p class="description"><?php _e('Địa chỉ nơi bạn đang ở.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-save save-personal-info" disabled="disabled" data-id="<?php echo $user_id; ?>"><?php _e('Lưu thay đổi', 'sb-login-page'); ?></button>
            ...
            <?php elseif('password' == $setting_page) : ?>
                <div class="module">
                    <div class="header">
                        <h2><?php _e('Mật khẩu', 'sb-login-page'); ?></h2>
                        <p class="description"><?php _e('Quản lý và thay đổi mật khẩu của bạn', 'sb-login-page'); ?></p>
                    </div>
                    <div class="content-inner">
                        <div class="control-group current-password">
                            <label for="user-current-password"><?php _e('Mật khẩu hiện tại', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                ...
                                <p class="description"><?php _e('Nhập vào mật khẩu hiện tại của bạn để thay đổi mật khẩu mới.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group password">
                            <label for="user-password"><?php _e('Mật khẩu mới', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                ...
                                <p class="description"><?php _e('Nhập mật khẩu mới.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group password-2">
                            <label for="user-password-2"><?php _e('Xác nhận mật khẩu', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-save btn-save-password" disabled="disabled" data-id="<?php echo $user_id; ?>"><?php _e('Lưu thay đổi', 'sb-login-page'); ?></button>
                            <span class="spinner-small settings-save-spinner"></span>
                        </div>
                    </div>
                </div>
            <?php else : ?>
                <div class="module">
                    <div class="header">
                        <h2><?php _e('Thông tin tài khoản', 'sb-login-page'); ?></h2>
                        <p class="description"><?php _e('Thay đổi thông tin cá nhân và tài khoản của bạn', 'sb-login-page'); ?></p>
                    </div>
                    <div class="content-inner">
                        <div class="control-group username">
                            <label for="user-login"><?php _e('Tên tài khoản', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                ...
                                <p class="description"><?php _e('Tài khoản của bạn là duy nhất và không thể thay đổi.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="control-group email">
                            <label for="user-login"><?php _e('Địa chỉ email', 'sb-login-page'); ?></label>
                            <div class="controls">
                                <p class="notification"></p>
                                <input type="text" id="user-email" class="user-email" name="user-email" value="<?php echo $user->user_email; ?>" autocomplete="off">
                                <p class="description"><?php _e('Địa chỉ email của bạn sẽ được giữ bí mật.', 'sb-login-page'); ?></p>
                            </div>
                        </div>
                        <div class="form-actions">
