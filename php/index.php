<html>
 <head>
  <title>Craig Godfrey</title>
    <meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="description" content=""/>
    <link rel="shortcut icon" href="assets/images/cdgui.png" />
    <link rel="canonical" href="http://cdgui.com" />
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
    <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" type="text/css" media="all" />
   ...
   <nav>
     <div class="container-fluid">
         <div class="row">
           ...
           <div class="col-sm-4 col-md-3 text-sm-center d-none d-sm-block">
             <a href="#play" title="">downtime</a>
           </div>
           <div class="col-sm-4 col-md-3 text-sm-center d-none d-sm-block">
             <a href="#contact" title="">connect</a>
           </div>
           ...
           <div class="col-xs-12 col text-center text-md-left">
            ...
            <!-- Begin MailChimp Signup Form -->
              ...
              <div id="mc_embed_signup">
                <form action="https://cdgui.us18.list-manage.com/subscribe/post?u=15b8d7bea7bd83d7029efa5d1&amp;id=ed6a4b544f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                <div id="mc_embed_signup_scroll" class="row">

                <div class="mc-field-group col-xs-12 col-lg-6 col-xl-4">
